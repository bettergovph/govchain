...
export const metadata = {
  title: "Open Standards on Blockchain - OpenGovChain",
  description:
    "Blockchain-backed Open Contracting Data Standard (OCDS) and Open Contracting for Infrastructure (OC4IDS) for transparent procurement and infrastructure data.",
};
